# purpose: calculate log-Pearson type III frequency factor (kt)
...
logpearson3_factor_calc <- function(my_probability_list, cskew) {
  ...
  # cskew represents the coefficient of skew for data of interest and is calculated outside the function
